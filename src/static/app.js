      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.innerHTML = `
          ...
          <ul class="participants-list">
            ${details.participants.length > 0 ? details.participants.map(p => `<li>${p} <button class="delete-btn" data-participant="${p}" data-activity="${name}">×</button></li>`).join('') : '<li>No participants yet.</li>'}
          </ul>
        `;
